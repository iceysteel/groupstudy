...
var config = {
    ...
    onRoomFound: function(room) {
        ...
        tr.innerHTML = '<td><strong>Looks like a video call for this class is starting!</td>' +
...
function captureUserMedia(callback, failure_callback, forceSkipCustomGetUserMediaBar) {
    if(!forceSkipCustomGetUserMediaBar) {
        ...
        //this is like a shiv for all the different browser's names from getuserMedia
        navigator.getUserMedia = ( navigator.getUserMedia ||
       navigator.webkitGetUserMedia ||
       navigator.mozGetUserMedia ||
       navigator.msGetUserMedia);
        
        navigator.getUserMedia(mediaConstraints, function () {
